...
contract RwaLending is IERC1155Receiver, OwnerIsCreator, ReentrancyGuard {
    ...
    AggregatorV3Interface internal s_usdcUsdAggregator; // Data feed
    ...
    constructor(
        ...
        i_ltvInitialThreshold = 60; // Correspond to the value of the loan
        i_ltvLiquidationThreshold = 75; // if dropped below this value it anyone can liquidated 
    }
    ...
    function getValuationInUsdc(uint256 tokenId) public view returns (uint256) {
        RealEstateToken.PriceDetails memory priceDetails = i_realEstateToken.getPriceDetails(tokenId); // comes in usd
